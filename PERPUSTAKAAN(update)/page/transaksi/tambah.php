...
<?php
    ...
    $simpan = $_POST['simpan'];
        ...
        $sql = $koneksi->query("insert into tb_transaksi(judul, no_kartu, nama, tgl_pinjam, tgl_kembali, status) values('$judul', '$no_kartu', '$nama', '$tgl_pinjam', '$tgl_kembali', 'Pinjam')");
